...
/*
** http://web.archive.org/web/20090617110918/
** http://www.openasthra.com/c-tidbits/printing-binary-trees-in-ascii/
**
** http://web.archive.org/web/20071224095835/
** http://www.openasthra.com:80/wp-content/uploads/2007/12/binary_trees1.c
*/
...
asciinode	*build_ascii_tree_recursive(t_rbtree *t)
{
	...
	sprintf(node->label, "%d", *(int *)t->key);
...
// Filling in the edge_length and height fields of the specified tree
